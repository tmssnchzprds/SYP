              ...
              <div class="post">
                <div class="box bg-white shadow">
                  ...
                  <div class="meta meta-footer d-flex justify-content-between mb-0">
                    ...
                    <span><a href="index.php?mod=pelicula&ope=update&idpel=<?=$item->getIdpel()?>">Actualizar</a> </span>
                    <span><a href="index.php?mod=pelicula&ope=delete&idpel=<?=$item->getIdpel()?>">Eliminar</a> </span>
                  </div>
                </div>
                <!-- /.box -->
              </div>
