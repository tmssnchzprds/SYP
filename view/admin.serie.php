              ...
              <div class="post">
                <div class="box bg-white shadow">
                  ...
                  <div class="meta meta-footer d-flex justify-content-between mb-0">
                    ...
                    <span><a href="index.php?mod=serie&ope=update&idser=<?=$item->getIdser()?>">Actualizar</a> </span>
                    <span><a href="index.php?mod=serie&ope=delete&idser=<?=$item->getIdser()?>">Eliminar</a> </span>
                  </div>
                </div>
                <!-- /.box -->
              </div>
