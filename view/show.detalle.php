                            ...
                            <div class="box bg-white shadow">
                                <div class="meta row meta-footer d-flex mb-0">
                                    ...
                                    if (isset($_SESSION["usuario"])) {
                                        ?>
                                        <!-- Formulario de puntuacion de la serie o pelicula -->
                                        <div class="col">
                                    ...
                                    if (isset($_SESSION["usuario"])) {
                                        ?>
                                        <!-- Formulario para añadir a mis listas la serie o pelicula -->
                                        <div class="col">
                                        ...
                                        <table style="width: 100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:25%;">
                                                        ...
                                                        if (isset($_SESSION["usuario"])) {
                                                            ...
                                                            ?>
                                                            <!-- Formulario de puntuacion de la temporada de la serie -->
                                                        ...
                                                        if (isset($_SESSION["usuario"])) {
                                                            ?>
                                                            <!-- Formulario para marcar vista la temporada de la serie -->
                                                                ...
                                                                <tr><td style="width:60%;"><div class="meta meta-footer d-flex mb-0">&nbsp;&nbsp;&nbsp;&nbsp; Episodio <?= $i; ?></div></td>
                                                                    <td style="width:25%;">
                                                                        ...
                                                                        if (isset($_SESSION["usuario"])) {
                                                                            ...
                                                                            ?>
                                                                            <!-- Formulario de puntuacion del episodio de la serie -->
                                                                    ...
                                                                    <td style="width:10%;">
                                                                        ...
                                                                        if (isset($_SESSION["usuario"])) {
                                                                            ?>
                                                                            <!-- Formulario para marcar visto el episodio de la serie -->
                                            ...
                                            if (isset($_SESSION["usuario"])) {
                                                if ($_SESSION["usuario"]->type == 2 || $_SESSION["usuario"]->type == 0) {
                                                    ...
                                                    <tr>
                                                        <!-- Eliminar la ultima temporada de la serie -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3" style="width:50%;">
                                                            <!-- Formulario para añadir una temporada a la serie -->
